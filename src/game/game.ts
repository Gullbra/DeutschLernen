...
import { IGameState, IQuestionProfile, IQuestionReturnObject } from "../interfaces/IDataStructures";
import { IClassAdverb, IClassNoun, IWord, IClassPreposition, IClassAdjective, IWordclass } from "../interfaces/IWordsPhrasesGrammar";
import { inputProcessor } from "../util/util";
import { randomizeArrayElement, randomizeInt } from "../util/personalLib/pseudoRandomizing"
import { QWordClassNoun } from "./questions/qNouns";
import { QWordClassAdverb } from "./questions/qAdverbs";
import { QWordClassAdjective } from "./questions/qAdjectives";
// import { QWordClassPreposition } from "./questions/qPrepositions";
