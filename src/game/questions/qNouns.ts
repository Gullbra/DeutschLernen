import { isValidWordClassNoun } from "../../util/dataValidations";
import { IClassNoun } from "../../interfaces/IWordsPhrasesGrammar";
import { IGameState } from "../../interfaces/IDataStructures";
import { comparerContractions, comparerß, inputProcessor, lineUpTranslations, qResultMeaningUI, qResultSimpleUI } from "../../util/util";
import { randomizeArrayElement, randomizeInt } from "../../util/personalLib/pseudoRandomizing"
import { IConvertedNoun, NounCaseConverter } from "../gramarHandlers/nounCaseConverter";
