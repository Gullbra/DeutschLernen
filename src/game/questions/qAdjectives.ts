import { isValidWordClassAdjective } from "../../util/dataValidations";
import { IClassAdjective } from "../../interfaces/IWordsPhrasesGrammar";
import { IGameState } from "../../interfaces/IDataStructures";
import { QDegreeOfComparision } from "./aDegreesOfComparision";
import { AdjectiveDecliner } from "../gramarHandlers/adjectiveDeclension";
import { NounCaseConverter } from "../gramarHandlers/nounCaseConverter";
import { comparerContractions, comparerß, inputProcessor, qResultSimpleUI } from "../../util/util";
